...
{slide-start}
[size125]#*The Java Module System provides reliable configuration and strong encapsulation*#
{slide-end}

{slide-start}
[size125]#*You can mix classpath and module-path*#
{slide-end}

{slide-start}
[size125]#*You can create modular artifacts targeted at Java 8 or earlier versions*#
{slide-end}

{slide-start}
[size125]#*jlink*#

- [size125]#you can create custom runtime images with only the modules required by your application#

- [size125]#you can create your own JRE#
{slide-end}

{slide-start}
[size125]#*jpackage*#

- [size125]#you can create platform-specific application installers#

- [size125]#especially useful for GUI applications#
{slide-end}

{slide-start}
[size175]#*Use Maven or Gradle to build your modular code!*#
{slide-end}

== Resources

[size125]#*Code and slides of this talk: https://github.com/beryx/talk-jeeconf-2019*#
